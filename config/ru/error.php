...
/**
 * Strings for component 'error', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   error
...
$string['cannotnetgeo'] = 'Невозможно подключится к серверу NetGeo  http://netgeo.caida.org, проверьте настройки прокси или лучше установите файл с данными GeoLite City с сайта MaxMind';
...
$string['courserequestdisabled'] = 'Извините, но запрос на создание курсов отключен администратором';
...
$string['csvloaderror'] = 'Во время загрузки CSV-файла произошла ошибка!';
...
$string['dbsessionmysqlpacketsize'] = 'Обнаружена серьезная ошибка сессии.<br /><br />Пожалуйста, сообщите об этом администратору сервера. Эта проблема, скорее всего, вызвана слишком маленьким значением max_allowed_packet параметров MySQL.';
...
$string['idnumbertaken'] = 'Идентификационный номер уже используется для другого курса';
...
$string['invalidcourseid'] = 'Вы пытаетесь использовать неправильный ID курса: ({$a})';
...
$string['invalidgradeitmeid'] = 'Неверный id элемента оценивания';
...
$string['sessiondiskfull'] = 'На диске заполнен раздел, в котором хранятся данные сессий. Из-за этого сейчас невозможно войи в систему.<br /><br /> Пожалуйста, сообщите об этом администратору сервера.';
