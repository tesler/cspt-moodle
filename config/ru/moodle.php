...
/**
 * Strings for component 'moodle', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   moodle
...
$string['aimid'] = 'AIM ID';
$string['ajaxno'] = 'Нет: использовать базовые возможности Веб';
$string['ajaxuse'] = 'AJAX и Javascript';
$string['ajaxyes'] = 'Да: использовать расширенные возможности Веб';
$string['all'] = 'Все';
...
$string['clammovedfile'] = 'Файл был перемещен в указанную Вами папку карантина, его новое размещение - «{$a}»';
$string['clammovedfilebasic'] = 'Файл был перемещен в папку карантина.';
$string['clamquarantinedirfailed'] = 'Невозможно переместить файл в указанную папку карантина «{$a}». Вам необходимо исправить это, иначе зараженные файлы будут удаляться.';
...
$string['coursehelpnewsitemsnumber'] = 'Количество последних новостей, отображаемых справа на странице курса в блоке новостей.
...
$string['courseprofiles'] = 'Профили участника курсов';
...
Для изменения пароля проследуйте по ссылке:
...
$string['expirynotify'] = 'Уведомление об окончании записи на курс';
...
{$a->extendurl}';
$string['expirynotifystudents'] = 'Оповещать студентов';
...
$string['expirynotifystudents_help'] = 'Если была указана длительность записи на курс, то этот параметр определяет, будут ли студенты получать уведомление по электронной почте перед их отчислением из курса.';
$string['expirythreshold'] = 'Порог';
$string['expirythreshold_help'] = 'Если была указана длительность записи на курс, то этот параметр определяет за сколько дней студенты будут уведомлены об их отчислении из курса.';
...
$string['flashlinkmessage'] = 'Пожалуйста, обновите ваш Flash player:';
$string['flashupgrademessage'] = 'Для проигрывания этого содержимого необходим плагин Flash, но установленная у Вас версия устарела.

Возможно, после обновления Вам потребуется выйти из системы и войти снова.';
$string['folder'] = 'Папка';
...
$string['frontpagedescriptionhelp'] = 'Описание сайта, которое будет размещено на главной странице';
...
$string['healthnoproblemsfound'] = 'Не обнаружено проблем с состоянием системы!';
$string['healthproblemsdetected'] = 'Обнаружены проблемы с состоянием системы!';
$string['healthproblemsolution'] = 'Решение проблемы с состоянием системы';
...
$string['hidetopicfromothers'] = 'Скрыть тему';
$string['hideweekfromothers'] = 'Скрыть неделю';
$string['hits'] = 'Выбор';
...
$string['htmleditor'] = 'Использовать редактор HTML (только в некоторых браузерах)';
...
$string['interestslist_help'] = 'Введите через запятую свои интересы. Они будут отображаться в Вашем профиле в виде тегов.';
...
$string['legacythemesaved'] = 'Новая тема для устаревших браузеров сохранена.';
...
<li>Прочитайте это письмо и пройдите по указанной в нем ссылке.</li>
<li>Учетная запись будет подтверждена и Вы войдете в систему.</li>
<li>Теперь выберите заинтересовавший Вас курс. </li>
<li>Если для записи на курс требуется кодовое слово, воспользуйтесь тем, что получили у учителя.</li>
...
$string['notifyloginfailuresmessageend'] = '!!!!!!!!!!!!!!!Вы можете просмотреть эти логи по адресу {$a}/course/report/log/index.php?id=1&chooselog=1&modid=site_errors';
...
$string['screenreaderuse'] = 'Используется программа для чтения с экрана';
$string['screenreaderuse_help'] = 'Если выбрать значение "Да", то в некоторых местах, например в чате, будет включен интерфейс, адаптированный для людей с ограниченными возможностями.';
...
$string['showallweeks'] = 'Отобразить все недели';
...
$string['showtopicfromothers'] = 'Отобразить тему';
$string['showweekfromothers'] = 'Отобразить неделю';
$string['since'] = 'С';
...
$string['uploadextension'] = 'Загрузка файла остановлена по расширению';
...
$string['uploadformlimit'] = 'Загружаемый файл превысил ограничение на максимальный размер, установленный в форме';
...
$string['useforlegacytheme'] = 'Использовать для старых браузеров';
$string['useformaintheme'] = 'Использовать для современных браузеров';
...
$string['virusfound'] = 'Внимание, администратор! Clam AV обнаружил вирус в файле, загруженном пользователем {$a->user} в курс {$a->course}. Вот отчет антивируса:';
...
$string['virusplaceholder'] = 'В загруженном файле обнаружен вирус и файл был перемещен или удален. Пользователь оповещен.';
