...
/**
 * Strings for component 'qtype_ordering', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['addmoreanswers'] = 'Добавить еще элементов - ({$a})';
...
$string['ordering_help'] = 'Некоторые элементы отображаются в случайном порядке. Элементы можно расположить в правильном порядке.';
$string['orderingsummary'] = 'Расположите перемешанные элементы в правильном порядке.';
