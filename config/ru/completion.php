...
/**
 * Strings for component 'completion', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   completion
...
$string['addcourseprerequisite'] = 'Добавить необходимое условия для выполнения курса';
...
$string['completion-alt-auto-enabled'] = 'Система отметила этот элемент как выполненный, в соответствии с условиями';
$string['completion-alt-auto-fail'] = 'Выполнено (оценка ниже проходного балла)';
$string['completion-alt-auto-n'] = 'Не выполнено';
$string['completion-alt-auto-pass'] = 'Выполнено (оценка выше проходного балла)';
$string['completion-alt-auto-y'] = 'Выполнено';
$string['completion-alt-manual-enabled'] = 'Студенты могут вручную отмечать этот элемент как выполненный';
$string['completion-alt-manual-n'] = 'Не выполнено; выберите, чтобы отметить элемент как выполненный';
$string['completion-alt-manual-y'] = 'Выполнено; выберите, чтобы отметить элемент курса как невыполненный';
...
Если показана пунктирная отметка, то Вы можете щёлкнуть по ней, чтобы отметить завершение элемента (при повторном щелчке отметка снимается). Отметка не обязательна и является лишь способом отслеживания Вашего продвижения в курсе.

Если показано пустое поле для отметки - это значит, что она появится автоматически после завершения элемента в соответствии с установленными преподавателем условиями.';
...
$string['completion-title-manual-n'] = 'Отметить как выполненное';
$string['completion-title-manual-y'] = 'Отметить как невыполненное';
...
$string['courseprerequisites'] = 'Необходимо выполнение других курсов';
...
$string['deletecoursecompletiondata'] = 'Удалить данные о выполнении курса';
...
$string['passinggrade'] = 'Проходной балл для оценки за курс';
$string['pending'] = 'Ожидается';
$string['periodpostenrolment'] = 'Период после записи на курс';
$string['prerequisites'] = 'Необходимые условия';
$string['prerequisitescompleted'] = 'Необходимые условия выполнены';
...
$string['usernotenroled'] = 'Пользователь не записан на данный курс';
