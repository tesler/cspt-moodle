...
/**
 * Strings for component 'tag', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   tag
...
$string['deleted'] = 'Удаленный';
$string['deletedcoursetags'] = 'Удаленные теги курса';
...
$string['manageofficialtags'] = 'Управление официальными тегами';
...
$string['othertags'] = 'Другие теги (через запятую)';
...
$string['removetagfrommyinterests'] = 'Удалить «{$a}» из моих интересов';
$string['reset'] = 'Сброс';
...
$string['rssdesc'] = 'Эта RSS0-лента была автоматически сгенерирована Moodle и содержит сгенерированные пользователями теги для курсов.';
$string['rsstitle'] = 'RSS-лента тегов курса для пользователя: {$a}';
