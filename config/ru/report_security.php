...
/**
 * Strings for component 'report_security', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['check_openprofiles_details'] = '<p> Открытыми профилями пользователей могут злоупотреблять спамеры. Рекомендуется, чтобы были включены параметр или <code>Необходимо войти в систему для просмотра профилей</code>, или <code>Принуждать пользователей войти в систему</code>. </p>';
...
$string['security:view'] = 'Просматривать отчета «Сведения о безопасности»';
