...
/**
 * Strings for component 'lesson', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   lesson
...
$string['displayleftif'] = 'Отображать меню слева, только если оценка больше, чем';
...
$string['displayscorewithessays'] = 'Вы получили {$a->score} баллов из {$a->tempmaxgrade} за вопросы, оцененные автоматически. <br> Оценки за {$a->essayquestions} эссе будут поставлены и учтены позднее при выставлении итоговой оценки. <br> Ваша текущая оценка (без учета эссе): {$a->score} из {$a->grade}.';
...
$string['importppt_help'] = 'Эта функция позволяет сохранить как веб-страницы ZIP-архив слайдов PowerPoint 2003, и импортировать их в лекцию.';
...
$string['maximumnumberofanswersbranches_help'] = 'Этот параметр определяет максимальное число ответов, которое отображается на страницах лекции. Если используются только ответы "Верно/Неверно", можно установить значение 2. Этот параметр можно изменить в любое время, так как он влияет только на представление для преподавателя, на введенных данных он не отражается.';
...
$string['mediafile'] = 'Файл или веб-страница во всплывающем окне';
...
$string['modulename_help'] = 'Модуль лекций позволяет создавать набор страниц содержащих материал и проверочные вопросы.';
