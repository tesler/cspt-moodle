...
/**
 * Strings for component 'data', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   data
...
В текущем шаблоне могут использовать только теги из списка «Доступные теги».';
$string['availabletodate'] = 'Доступно до';
$string['blank'] = 'Пусто';
$string['buttons'] = 'Действия';
$string['bynameondate'] = '{$a->name} - {$a->date}';
$string['cancel'] = 'Отменить';
$string['cannotaccesspresentsother'] = 'Вам не разрешен доступ к заготовкам от других пользователей';
$string['cannotadd'] = 'Невозможно добавить записи!';
$string['cannotdeletepreset'] = 'Ошибка при удалении заготовки!';
...
$string['commentsoff'] = 'Комментарии не разрешены';
...
$string['data:exportallentries'] = 'Экспортировать все записи из базы данных';
$string['data:exportentry'] = 'Экспортировать запись из базы данных';
$string['data:exportownentry'] = 'Экспортировать свою запись из базы данных';
...
$string['data:manageuserpresets'] = 'Управлять предустановками шаблонов всех пользователей';
$string['data:rate'] = 'Оценивать записи';
$string['data:readentry'] = 'Читать записи';
$string['data:viewallratings'] = 'Видеть все промежуточные оценки';
$string['data:viewalluserpresets'] = 'Видеть предустановки шаблонов всех пользователей';
$string['data:viewanyrating'] = 'Видеть итоговые оценки любого пользователя';
$string['data:viewentry'] = 'Просматривать записи';
$string['data:viewrating'] = 'Видеть свою итоговую оценку';
...
$string['entrieslefttoadd'] = 'Чтобы просматривать записи других участников Вы должны добавить еще записи - ({$a->entriesleft})';
$string['entrieslefttoaddtoview'] = 'Вы должны еще добавить записи ({$a->entrieslefttoview}), прежде чем сможете просматривать записи других участников.';
$string['entry'] = 'Запись';
...
$string['exportaszip_help'] = 'Функция экспорт в ZIP позволяет сохранять шаблоны и поля как архив заготовки для загрузки. Архив ZIP затем может быть импортирован в другой курс.';
$string['exportedtozip'] = 'Экспортировано во временный ZIP...';
$string['exportentries'] = 'Экспорт записей';
$string['exportownentries'] = 'Экспортировать только собственные записи? ({$a->mine}/{$a->all})';
...
$string['fieldmappings_help'] = 'Это меню позволяет сохранять данные из существующей
базы данных. Чтобы сохранить данные в новом поле, нужно выбрать тип нового
поля из данного списка. Любое поле можно оставить пустым, без информации. Все старые поля, не отображенные в новом списке, будет потеряны и все данные удалены.
...
$string['fieldnotmatched'] = 'Следующие поля в файле не известны в этой базе данных: {$a}';
$string['fieldoptions'] = 'Варианты (по одному в каждой строке)';
$string['fields'] = 'Поля';
...
$string['fromfile_help'] = 'Функция импорта из ZIP-архива позволяет просматривать и загружать заготовки шаблонов и полей из ZIP-файла.';
$string['generateerror'] = 'Не все файлы созданы!';
...
$string['invalidaccess'] = 'Доступ к странице некорректен';
$string['invalidfieldid'] = 'ID поля некорректен';
$string['invalidfieldname'] = 'Пожалуйста, выберите другое название для этого поля';
$string['invalidfieldtype'] = 'Тип поля некорректен';
$string['invalidid'] = 'ID некорректен';
$string['invalidpreset'] = '{$a} - это не заготовка';
$string['invalidrecord'] = 'Неверная запись';
...
$string['latlonglinkservicesdisplayed'] = 'Отображать метки в';
...
$string['maxentries_help'] = 'Максимальное количество записей, которое может внести студент.';
$string['maxsize'] = 'Максимальный размер';
$string['menu'] = 'Выпадающий список';
$string['menuchoose'] = 'Выбрать...';
$string['missingdata'] = 'Данные объекта или ID должны быть предоставлены в классе поля';
$string['missingfield'] = 'Программная ошибка: Вы должны задать поля и/или данные при определении классов полей.';
$string['modulename'] = 'База данных';
$string['modulename_help'] = 'Элемент курса "База данных" позволяет участникам создавать, обслуживать и искать различные записи в хранилище. Формат и структура этих записей могут быть почти безграничными, в том числе изображения, файлы, гиперссылки, числа, текст и другие объекты.';
...
Каждое поле в базе данных должно именть уникальное название. Описание поля является необязательным.';
$string['noaccess'] = 'У Вас нет доступа к этой странице';
$string['nodefinedfields'] = 'Новая заготовка имеет неопределенные поля!';
$string['nofieldcontent'] = 'Содержимое поля не было найдено';
...
$string['overwritesettings'] = 'Перезаписать текущие настройки';
...
$string['portfolionotfile'] = 'Предпочтительнее экспортировать в портфолио, а не в файл (Только CSV и leap2a)';
$string['presetinfo'] = 'Сохранение в виде заготовки сделает этот шаблон общим. Другие пользователи могут использовать его в своих базах данных.';
...
$string['resizingimages'] = 'Изменение размера эскизов изображений ...';
$string['rows'] = 'строк';
$string['rssglobaldisabled'] = 'Отключено. См. переменные конфигурации сайта.';
...
$string['saveaspreset_help'] = 'Сохранение шаблона в виде заготовки с предварительными настройками полей позволит использовать ее любому человеку на сайте. Вы сможете удалить ее из списка в любое время.</p>';
$string['savesettings'] = 'Сохранить настройки';
$string['savesuccess'] = 'Сохранено успешно. Ваша заготовка теперь будет доступна на сайте.';
$string['savetemplate'] = 'Сохранить шаблон';
$string['search'] = 'Поиск';
$string['selectedrequired'] = 'Требуются все выбранные';
