...
/**
 * Strings for component 'workshopallocation_manual', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['addreviewee'] = 'Добавить рецензируемого';
$string['addreviewer'] = 'Добавить рецензента';
$string['allocationadded'] = 'Работа успешно распределена';
$string['allocationexists'] = 'Распределение уже сделано';
