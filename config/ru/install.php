...
/**
 * Strings for component 'install', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   install
...
$string['dbtype'] = 'Тип';
$string['dbwrongencoding'] = 'Выбранный сервер баз данных работает с нерекомендованной кодировкой ({$a}). Гораздо лучше использовать базу данных с кодировкой Unicode (UTF-8). Конечно, Вы можете пропустить эту проверку указав параметр «Пропустить тест кодировки», но в будущем у Вас могут возникнуть проблемы.';
