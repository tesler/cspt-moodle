...
/**
 * Strings for component 'cohort', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   cohort
...
$string['cohort:assign'] = 'Назначать участников группы';
$string['cohort:manage'] = 'Управлять глобальными группами';
$string['cohorts'] = 'Глобальные группы';
$string['cohortsin'] = '{$a}: доступные глобальные группы';
$string['cohort:view'] = 'Использовать глобальные группы и видеть участников';
