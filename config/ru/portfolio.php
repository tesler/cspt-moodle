...
/**
 * Strings for component 'portfolio', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   portfolio
...
$string['enableddesc'] = 'Это позволит администраторам настраивать внешние системы, в которые пользователи смогут экспортировать содержимое.';
...
$string['leap2a_invalidentryid'] = 'Вы пытаетесь получить доступ к записи по идентификатору, который не существует ({$a})';
...
$string['nocallbackfile'] = 'Что-то нарушено в модуле, который Вы пытаетесь экспортировать - не удается найти требуемый файл ({$a})';
