...
/**
 * Strings for component 'block_quiz_results', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['bestgroupgrade'] = 'Группа с самой высокой средней оценкой:';
$string['bestgroupgrades'] = '{$a} групп(ы) с самой высокой средней оценкой:';
$string['config_format_absolute'] = 'Абсолютные значения';
$string['config_format_fraction'] = 'Абс. значение/Макс. значение';
...
$string['worstgroupgrades'] = '{$a} групп(ы) с самой высокой средней оценкой:';
