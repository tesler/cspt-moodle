...
/**
 * Strings for component 'glossary', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   glossary
...
$string['modulename_help'] = 'Модуль глоссария позволяет участникам создавать и поддерживать список определений, подобный словарю. Термины глоссария, встретившиеся где-либо в текстах курса, могут быть автоматически превращены в ссылки на страницы глоссария, содержащие определение данного термина.';
