...
/**
 * Strings for component 'assignment', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   assignment
...
$string['enableemailnotification_help'] = 'Если параметр включен, ученики будут получать уведомления по электронной почте о том, что их ответы были оценены.';
...
$string['messageprovider:assignment_updates'] = 'Уведомления о задании';
...
$string['nosubmitusers'] = 'Пользователи, у которых есть права для выполнения этого задания, не найдены.';
