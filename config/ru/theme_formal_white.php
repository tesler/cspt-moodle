...
/**
 * Strings for component 'theme_formal_white', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['blockcolumnwidthdesc'] = 'Этот параметр устанавливает ширину колонки блоков для этой темы оформления. <strong>Блок "Календарь" не поместится в колонку, если указать значение меньшее, чем 200 пикселей.</strong>';
...
$string['displaylogo'] = 'Содержимое заголовка страницы';
$string['displaylogodesc'] = 'Выберите, что отображать в заголовке страницы - логотип Moodle или текст заголовка.';
...
$string['heading'] = 'Отображать заголовок страницы';
...
$string['logo'] = 'Логотип';
$string['logodesc'] = 'Можно изменить логотип, используемый этой темой, указав URL нового (например: http://www.somesite/animage.png). По умолчанию используется логотип шириной 300 и высотой 80 пикселей. Лучше использовать PNG-файл c прозрачным фоном.<br />Выбранный логотип будет отображаться на всех страницах сайта без разделения на главную и остальные страницы.';
$string['moodlelogo'] = 'Отображать логотип Moodle';
...
$string['rblockcolumnbgcdesc'] = 'Параметр задаёт цвет фона правой колонки этой темы оформления. Если оставить поле пустым, то будет использоваться цвет фона левой колонки.';
