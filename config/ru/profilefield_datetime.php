...
/**
 * Strings for component 'profilefield_datetime', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['currentdatedefault'] = 'Поставьте отметку, чтобы в качестве значения по умолчанию использовалась текущая дата';
$string['defaultdate'] = 'Дата по умолчанию';
...
$string['wanttime'] = 'Включать время?';
