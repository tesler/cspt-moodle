...
/**
 * Strings for component 'block_rss_client', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['addfeed'] = 'Добавить адрес (URL) новой ленты';
...
$string['editfeeds'] = 'Редактировать, подписаться/отписаться от новостной ленты RSS/Atom';
...
$string['feedstitle'] = 'Внешние RSS-ленты';
$string['feedupdated'] = 'Новостная лента обновлена';
$string['feedurl'] = 'URL-адрес ленты';
$string['findmorefeeds'] = 'Искать еще RSS-ленты';
$string['managefeeds'] = 'Редактировать все мои ленты';
...
$string['updatefeed'] = 'Обновить адрес (URL) новостной ленты:';
