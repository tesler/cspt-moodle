...
/**
 * Strings for component 'hub', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   hub
...
$string['advertise'] = 'Разместите информацию о Вашем курсе, чтобы желающие могли принять участие';
$string['advertised'] = 'Размещена ссылка';
$string['advertiseon'] = 'Разместить информацию об этом курсе в каталоге «{$a}»';
$string['advertiseonhub'] = 'Разместить информацию об этом курсе в каталоге';
$string['advertiseonmoodleorg'] = 'Разместить информацию об этом курсе на moodle.org';
$string['advertisepublication_help'] = 'Размещение информации о Вашем курсе в общественном каталоге позволит желающим найти его и перейти сюда, чтобы записаться.';
$string['all'] = 'Все';
...
$string['coursepublished'] = 'Курс успешно опубликован в каталоге «{$a}».';
...
$string['description_help'] = 'Текст описания будут отображаться в списке курсов в каталоге';
$string['detectednotexistingpublication'] = 'В каталоге «{$a->hubname}» присутствует курс, который больше не существует. Сообщите администрации этого каталога, что что следует удалить публикацию № {$a->id}.';
...
$string['errorcourseinfo'] = 'Произошла ошибка при извлечении метаданных курса из узла ({$a}). Попробуйте снова извлечь метаданные курса из узла, позже перезагрузив эту страницу. Вы также можете решить продолжить решистрацию процесса с метаданными по умолчанию.';
$string['errorcoursepublish'] = 'Во время публикации курса произошла ошибка ({$a}). Попробуйте снова позже.';
$string['errorcoursewronglypublished'] = 'Каталог вернул сообщение об ошибке публикации. Попробуйте снова позже.';
...
$string['errorhublisting'] = 'Произошла ошибка получения списка каталога с Moodle.org, пожалуйста, попробуйте снов позже. ({$a})';
...
$string['errorunpublishcourses'] = 'В связи с непредвиденной ошибкой не удалось удалить курсы из каталога. Попробуйте повторить операцию позже (рекомендуется) или свяжитесь с администрацией каталога.';
$string['existingscreenshotnumber'] = 'Созданные скриншоты - {$a}. Вы сможете видеть эти скриншоты на странице только после того, как администратор узла откроет Ваш курс.';
...
$string['notregisteredonhub'] = 'Для того, чтобы Вы могли опубликовать курс, администратору необходимо зарегистрировать сайт хотя бы в одном каталоге. Свяжитесь с администратором вашего сайта.';
...
$string['publishedon'] = 'Опубликован в';
...
$string['publishonmoodleorg'] = 'Опубликовать в MOOCH';
...
$string['registeredon'] = 'Зарегистрирован в';
$string['registeredsites'] = 'Зарегистрированные сайты';
$string['registeron'] = 'Регистрация Вашего сайта';
$string['registeronmoodleorg'] = 'Зарегистрироваться в каталоге Moodle.org (MOOCH)';
$string['registeronspecifichub'] = 'Зарегистрироваться в другом каталоге';
$string['registersite'] = 'Зарегистрироваться в каталоге «{$a}»';
$string['registrationconfirmed'] = 'Регистрация сайта подтверждена';
$string['registrationconfirmedon'] = 'Теперь Вы зарегистрированы в каталоге «{$a}». Вы можете опубликовывать курсы в этом каталоге с помощью ссылки «Опубликовать» в меню «Управление курсом».';
...
$string['removefromhub'] = 'Убрать из каталога';
...
$string['shared'] = 'Размещен файл';
$string['shareon'] = 'Загрузить этот курс в каталог «{$a}»';
$string['shareonhub'] = 'Загрузить этот курс в каталог';
$string['shareonmoodleorg'] = 'Загрузить этот курс в MOOCH';
$string['sharepublication_help'] = 'Загрузка курсов в общественный каталог позволит желающим загрузить их и установить на своих сайтах Moodle.';
...
$string['sitedesc_help'] = 'В списке сайтов каталога может отображаться это описание. Пожалуйста, вводите только текст (без HTML)';
$string['siteemail'] = 'Адрес электронной почты';
$string['siteemail_help'] = 'Чтобы администратор каталога мог связаться с Вами в случае необходимости. Адрес не будет использоваться ни в каких других целях. Рекомендуется ввести адрес электронной почты, связанный с должностью (пример: sitemanager@example.com), а не с конкретным человеком.';
...
$string['sitelang_help'] = 'В списке сайтов будет указан язык Вашего сайта';
...
$string['siteprivacy'] = 'Конфиденциальность';
$string['siteprivacylinked'] = 'Опубликовывать название сайта и ссылку';
$string['siteprivacynotpublished'] = 'Не опубликовывать сайт';
$string['siteprivacypublished'] = 'Опубликовать только название сайта';
$string['siteregconfcomment'] = 'Ваш сайт требует окончательного подтверждения на {$a} (во избежание спама на {$a})';
$string['siteregistrationcontact'] = 'Форма для связи';
$string['siteregistrationcontact_help'] = 'Если Вы захотите, то другие люди смогут связаться с Вами через форму контактов каталога. Они никогда не будут видеть адрес Вашей электронной почты.';
$string['siteregistrationemail'] = 'Уведомления по электронной почте';
$string['siteregistrationemail_help'] = 'Если включить этот параметр, то администратор каталога сможет отправлять Вам по электронной почте письма с важными новостями, например, по вопросам безопасности.';
...
$string['specifichub'] = 'Другой каталог';
...
$string['type'] = 'Разрекламирован / Общедоступен';
...
$string['unpublishalladvertisedcourses'] = 'Убрать из каталога все размещенные там ссылки на курсы';
$string['unpublishalluploadedcourses'] = 'Убрать из каталога все загруженные туда курсы';
$string['unpublishconfirmation'] = 'Вы действительно собираетесь убрать курс «{$a->courseshortname}» из каталога «{$a->hubname}»?';
$string['unpublishcourse'] = 'Убрать курс «{$a}» из каталога';
