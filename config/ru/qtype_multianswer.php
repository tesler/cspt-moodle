...
/**
 * Strings for component 'qtype_multianswer', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['addingmultianswer'] = 'Добавление вопроса "Вложенные ответы" (Cloze)';
...
$string['multianswer_help'] = 'Вопросы "Вложенные ответы" (Cloze) представляют собой текст с вложенными в него вопросами, такими, как "Множественный выбор", "Числовой ответ" и "Короткий ответ".';
$string['multianswersummary'] = 'Вопросы такого типа являются очень гибкими, но могут быть созданы только путем ввода текста со специальными кодами, которые создают встроенные вопросы "Множественный выбор", "Числовой ответ" и "Короткий ответ".';
...
$string['questionnadded'] = 'Вопрос добавлен';
