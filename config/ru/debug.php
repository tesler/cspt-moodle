...
/**
 * Strings for component 'debug', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   debug
...
$string['invalidparameter'] = 'Обнаружено неверное значение параметра, выполнение невозможно.';
$string['invalidresponse'] = 'Обнаружено неверное значение ответа, выполнение невозможно.';
...
$string['noactivityname'] = 'Объект страницы унаследован от page_generic_activity, но не определяет значение $this->activityname';
