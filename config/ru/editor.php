...
/**
 * Strings for component 'editor', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   editor
...
$string['acteditorshhdr'] = 'Доступные текстовые редакторы';
...
$string['imageurl'] = 'Адрес изображения';
...
$string['showhelp'] = 'Справка по использованию редактора';
$string['size'] = 'Размер';
