...
/**
 * Strings for component 'forum', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   forum
...
$string['cannotdeleteforummodule'] = 'Вы не можете удалить форум.';
...
$string['forumbodyhidden'] = 'Вы не можете посмотреть это сообщение. Вероятно, Вы еще не отвечали в этой теме или ещё не закончилось время для редактирования ответа.';
...
$string['modulename_help'] = 'Модуль "Форум" позволяет участникам общаться в асинхронном режиме.';
...
$string['nownotsubscribed'] = 'Пользователь "{$a->name}" больше НЕ будет получать копии сообщений форума "{$a->forum}" по электронной почте.';
$string['nownottracking'] = 'Слежение за новыми сообщениями в \'{$a->forum}\' отключено для {$a->name}.';
$string['nowsubscribed'] = 'Пользователь "{$a->name}" будет получать копии сообщений форума "{$a->forum}" по электронной почте.';
...
$string['subscribeenrolledonly'] = 'Извините, только зарегистрированным пользователям разрешено подписаться на получение сообщений форума по электронной почте.';
...
* Не обязательно  - участники могут сами выбрать - включить отслеживание или нет
* Да - отслеживание всегда включено
