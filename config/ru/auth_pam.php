...
/**
 * Strings for component 'auth_pam', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   auth_pam
...
$string['auth_passwordisexpired'] = 'Срок действия Вашего пароля закончился. Вы хотите изменить свой пароль сейчас?';
