...
/**
 * Strings for component 'auth_shibboleth', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['auth_shib_no_organizations_warning'] = 'Если Вы хотите использовать встроенную службу WAYF, Вы должны предоставить разделенный запятыми список поставщиков удостоверений: entityID, название и (не обязательно) инициатор сессии.';
...
$string['auth_shib_username_description'] = 'Имя переменной среды Shibboleth веб-сервера, которая должна использоваться в качестве имени пользователя Moodle';
