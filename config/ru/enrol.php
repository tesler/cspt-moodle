...
/**
 * Strings for component 'enrol', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   enrol
...
$string['deleteinstanceconfirm'] = 'Вы действительно хотите удалить способ записи
"{$a->name}" с {$a->users} зарегистрированными пользователями?';
...
$string['uninstallconfirm'] = 'Вы собираетесь полностью удалить способ записи "{$a}". При этом из базы данных будет полностью удалено всё, что связано с этим типом записи. Вы УВЕРЕНЫ, что хотите продолжить?';
