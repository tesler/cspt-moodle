...
/**
 * Strings for component 'recordingsbn', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['event_recording_deleted'] = 'Запись удалена';
$string['event_recording_published'] = 'Запись опубликована';
$string['event_recording_unpublished'] = 'Публикация записи отменена';
...
$string['view_head_course'] = 'Курс';
$string['view_head_date'] = 'Дата';
$string['view_head_description'] = 'Описание';
$string['view_head_duration'] = 'Продолжительность';
$string['view_head_length'] = 'Длина';
$string['view_head_recording'] = 'Запись';
$string['view_noguests'] = 'Гости не могут просматривать записи видеоконференций BigBlueButton';
