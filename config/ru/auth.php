...
/**
 * Strings for component 'auth', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   auth
...
$string['authinstructions'] = 'Здесь Вы можете написать инструкции для своих пользователей, чтобы они знали, какой логин и пароль им следует использовать. Текст, который Вы вводите здесь, появится на странице входа в систему. Если оставить поле пустым, никаких инструкций отображено не будет.';
