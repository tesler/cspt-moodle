...
/**
 * Strings for component 'editor_tinymce', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['advanced:clipboard_msg'] = 'Команды Копировать/Вырезать/Вставить не работают в Firefox.nХотите узнать об этом подробнее?';
