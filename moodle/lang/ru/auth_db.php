...
/**
 * Strings for component 'auth_db', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbhost'] = 'Сетевое имя или адрес компьютер, на котором расположен сервер базы данных';
...
$string['auth_dbtype'] = 'Тип базы данных (Подробнее в <a href="../lib/adodb/readme.htm#drivers">документации по ADOdb</a>)';
