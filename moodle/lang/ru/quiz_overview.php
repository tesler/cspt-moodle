...
/**
 * Strings for component 'quiz_overview', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['attemptprogress'] = 'Попытка {$a->done} из {$a->todo}';
...
$string['qprogress'] = 'Вопрос {$a->done} из {$a->todo}';
