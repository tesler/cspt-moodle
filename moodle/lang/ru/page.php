...
/**
 * Strings for component 'page', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   page
...
$string['modulename'] = 'Страница';
$string['modulename_help'] = 'Страница - это обычная веб-страница, показываемая и редактируемая внутри курса.';
$string['modulenameplural'] = 'Страницы';
$string['neverseen'] = 'Не смотрел(а)';
$string['optionsheader'] = 'Настройки';
$string['page:view'] = 'Просматривать содержимое страницы';
$string['pluginadministration'] = 'Управление модулем «Страница»';
$string['pluginname'] = 'Страница';
