...
/**
 * Strings for component 'grades', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   grades
...
$string['importfailed'] = 'Импорт не удался';
...
$string['showuseridnumber_help'] = 'Если параметр включен, ID пользователя отображается в дополнительной колонке.';
