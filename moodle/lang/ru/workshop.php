...
/**
 * Strings for component 'workshop', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   workshop
...
$string['allsubmissions'] = 'Все работы';
...
$string['evaluationmethod_help'] = 'Метод оценивания оценок определяет, как вычисляются баллы за оценивание. В настоящее время существует  только один вариант - сравнение с "лучшей" (чаще встречающейся, средней) оценкой.';
...
$string['switchphase10info'] = 'Вы собираетесь переключить семинар в фазу <strong>  "Настройка"</strong>. В этой фазе пользователи не могут изменять свои работы или оценки работ. Преподаватели могут использовать эту фазу для изменения настроек семинара, изменения стратегии оценки и корректировки формы оценки.';
