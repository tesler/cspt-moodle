...
/**
 * Strings for component 'role', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   role
...
$string['community:add'] = 'Использовать блок «Поиск в общественных каталогах» для поиска курсов в каталогах';
...
$string['restore:restoretargethub'] = 'Восстанавливать курсы из файлов, предназначенных для общественных каталогов';
