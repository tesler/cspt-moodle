...
/**
 * Strings for component 'group', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   group
...
$string['createingrouping'] = 'Создать в потоке';
...
$string['groupmembersonly'] = 'Доступно только для членов группы';
$string['groupmembersonlyerror'] = 'Извините, Вы должны быть участником по меньшей мере одной группы, используемой в этом элементе курса.';
$string['groupmembersonly_help'] = 'Если флажок отмечен, элемент курса (или ресурс) будет доступен только для студентов в группах выбранного потока.';
