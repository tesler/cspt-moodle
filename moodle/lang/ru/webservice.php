...
/**
 * Strings for component 'webservice', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   webservice
...
$string['accessnotallowed'] = 'Доступ к веб-службе не разрешен';
...
$string['errorinvalidparamsapi'] = 'Недопустимый параметр внешнего API';
$string['errorinvalidparamsdesc'] = 'Неверное описание внешнего API';
$string['errorinvalidresponseapi'] = 'Неверный ответ внешнего API';
$string['errorinvalidresponsedesc'] = 'Неверное описание ответа внешнего API';
$string['errormissingkey'] = 'Отсутствует необходимый ключ в одиночной структуре: {$a}';
...
$string['erroronlyarray'] = 'Принимаются только массивы.';
...
$string['errorresponsemissingkey'] = 'Ошибка в ответе - отсутствует следующий необходимый ключ в одиночной структуре: {$a}';
$string['errorscalartype'] = 'Ожидаемый тип - скаляр, получен массив или объект.';
$string['errorunexpectedkey'] = 'Непредвиденные ключи ({$a}) обнаружены в параметре массива.';
...
$string['testclientdescription'] = '* Клиент для тестирования веб-служб <strong>запускает</strong> функции <strong>ПО-НАСТРОЯЩЕМУ</strong>. Не тестируйте неизвестные Вам функции.<br/>* Не все существующие функции веб-служб Moodle реализованы в клиенте для тестирования.<br/>* Для проверки того, что пользователь не может получить доступ к некоторым функциям, Вы можете попробовать запустить некоторые функции, которые Вам не разрешены.<br/>* Чтобы увидеть более подробные сообщения об ошибках, установите параметр {$a->atag} в значение <strong>{$a->mode}</strong>.<br/>* Также доступен {$a->amfatag}.';
...
$string['wsauthmissing'] = 'Плагин аутентификации веб-службы отсутствует.';
$string['wsauthnotenabled'] = 'Плагин аутентификации веб-службы отключен.';
