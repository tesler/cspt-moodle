...
/**
 * Strings for component 'block_glossary_random', language 'ru', branch 'MOODLE_20_STABLE'
 *
...
$string['whichfooter'] = 'Вы можете отобразить ссылки на действия в глоссарии, с которым ассоциируется блок. Блок отобразит только те действия, которые доступны для этого глоссария.';
