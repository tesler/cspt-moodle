...
/**
 * Strings for component 'repository', language 'ru', branch 'MOODLE_20_STABLE'
 *
 * @package   repository
...
$string['confirmdelete'] = 'Вы уверены, что хотите удалить это хранилище - {$a}?';
$string['confirmdeletefile'] = 'Вы уверены, что хотите удалить это файл?';
$string['confirmremove'] = 'Вы уверены, что хотите удалить плагин этого хранилища, его настройки и <strong>все его экземпляры</strong> - {$a}?';
...
$string['renameto'] = 'Переименовать в';
